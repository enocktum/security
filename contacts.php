    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">Contact Us through</h1>
						<p>
						<ul>
						<li>Email us: yourname@domain.com</li>
						<li>Visit us:<a href="http://www.enosoft.tk">www.enosoft.tk</a></li>
						<li>Call us :+254702000775</li>
						</ul>
						</p>
                    </div>
                </div>
