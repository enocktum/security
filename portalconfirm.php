            ...
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-lg-12">
						...
						{
							$query=mysqli_query($con,"select * from login where username='$username' && password='$password'");
							$number=mysqli_num_rows($query);
							if($number>0)
							{
								session_start();
								$_SESSION['ologin']=$username;
						...
						{
							echo"please fill all the variables first<a href='portal.php'>click here to go back</a>";
						}
						?>
						</center>
						</p>
